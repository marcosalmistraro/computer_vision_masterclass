...
# this background is a global variable that gets updated through a few functions
background = None
...
def calc_accum_avg(frame, accumulated_weight):
    ...
    # as a starting poing, create the background from a copy of the frame.
...
def count_fingers(thresholded, hand_segment):
    ...
    # let's grab those points by using argmin and argmax
    ...
    # do not grab an ROI of only that circle
